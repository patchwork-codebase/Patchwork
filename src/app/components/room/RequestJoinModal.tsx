          ...
          {success ? (
            ...
            <>
              ...
              <div className="flex gap-3">
                <button
                  onClick={onClose}
                  className="flex-1 py-3 bg-white border border-slate-100 text-slate-700 hover:bg-slate-50 font-bold rounded-xl transition-all shadow-sm dark:shadow-none"
                >
                  Cancel
                </button>
                <button
