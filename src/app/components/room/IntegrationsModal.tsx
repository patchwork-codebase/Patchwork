    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm">
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-2xl border border-slate-100/80 w-full max-w-xl overflow-hidden"
        >
          {/* Header */}
          ...
          <div className="p-6 space-y-6 max-h-[65vh] overflow-y-auto">
            ...
            <div className="p-5 rounded-2xl border border-slate-100/80 bg-white hover:border-slate-300 transition-all shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-slate-900 text-slate-900 dark:text-white flex items-center justify-center font-bold text-sm">
                    GH
                  </div>
                  <div>
              ...
              {!githubIntegration ? (
                <button
                  ...
                  className="w-full mt-2 py-2.5 bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 bg-slate-50 border border-slate-100 rounded-xl px-3 py-2 text-xs font-mono text-slate-700 truncate select-all shadow-sm dark:shadow-none"
                      />
                      <button
            ...
            <div className="p-5 rounded-2xl border border-slate-100/80 bg-white hover:border-slate-300 transition-all shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-indigo-600 text-slate-900 dark:text-white flex items-center justify-center font-bold text-sm">
                    LN
                  </div>
                  <div>
                    <h4 className="text-sm font-extrabold text-slate-900 flex items-center gap-2">
              ...
              {!linearIntegration ? (
                <button
                  ...
                  disabled={setupIntegration.isPending}
                  className="w-full mt-2 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-slate-900 dark:text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  <Layers className="w-3.5 h-3.5" />
          ...
          {/* Footer */}
          <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex justify-end shadow-sm dark:shadow-none">
            <button
              onClick={onClose}
              className="px-5 py-2.5 bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-xs font-bold rounded-xl transition-all"
            >
              Done
            </button>
          </div>
