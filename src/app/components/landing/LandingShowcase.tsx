...
export function LandingShowcase({
  ...
  return (
            <section id="showcase" className="relative py-24 bg-[#FAFAF9] border-y border-slate-200">
              <div className="absolute top-[20%] left-[-5%] w-[40%] h-[40%] rounded-full bg-primary-400/5 blur-[120px] pointer-events-none" />
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-0">
                            <div className="flex items-center gap-3 sm:gap-4">
                              ...
                              <div className="min-w-0">
                                <div className="text-[15px] sm:text-[16px] font-extrabold text-slate-900 flex flex-wrap items-center gap-1.5 sm:gap-2 font-display group-hover:text-primary-400 transition-colors">
                            ...
                            <span className="self-start sm:self-auto rounded-md bg-white shadow-sm px-2 sm:px-2.5 py-1 text-[9px] sm:text-[10px] font-bold font-mono uppercase text-primary-400 ring-1 ring-white/[0.05] tracking-widest">
                              {builder.domain}
                            </span>
                          </div>
