...
export function LandingUseCases() {
  ...
  return (
    <section id="use-cases" className="relative py-24 sm:py-32 bg-[#050505] overflow-hidden border-y border-white/5">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16 md:text-center max-w-2xl md:mx-auto">
          ...
          >
            ...
            <p className="mt-4 text-lg text-slate-400 max-w-xl md:mx-auto">
        ...
        <div className="grid lg:grid-cols-[400px_1fr] gap-8 lg:gap-12 items-center">
              ...
              return (
                <button
                  ...
                  className={`text-left p-5 rounded-2xl transition-all duration-300 relative overflow-hidden group ${
                    isActive 
                      ? `bg-[#1C1A24] border border-white/10 shadow-lg shadow-black/50` 
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 shrink-0 rounded-xl flex items-center justify-center transition-colors duration-300 ${isActive ? useCase.lightColor + " " + useCase.textColor : "bg-[#2A2635] text-slate-500 group-hover:text-slate-300"}`}>
                      {useCase.icon}
                    </div>
                    <div>
                      <h3 className={`text-lg font-extrabold transition-colors duration-300 ${isActive ? "text-white" : "text-slate-400"}`}>
                        {useCase.title}
                      </h3>
                      ...
                      <AnimatePresence>
                        {isActive && (
                          ...
                          >
                            <p className="text-[15px] text-slate-400 leading-relaxed mt-3 font-medium">
                              {useCase.description}
                            </p>
                            <div className="mt-4 flex items-center gap-2">
                              <img src={useCase.avatar} alt="Avatar" className="w-6 h-6 rounded-full bg-[#2A2635] border border-white/10" />
          ...
          <div className="relative h-[400px] sm:h-[500px] rounded-[32px] bg-[#0E0C15] border border-white/10 shadow-inner overflow-hidden">
