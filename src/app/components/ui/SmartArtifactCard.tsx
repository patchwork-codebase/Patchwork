...
export function SmartArtifactCard({ url }: { url: string }) {
  ...
  return (
    <div className="mt-4 border border-slate-200 bg-slate-50 rounded-2xl overflow-hidden relative group">
      <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#8B7CF8]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="p-4 flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="text-[10px] font-bold text-[#8B7CF8] uppercase tracking-widest mb-1">AI Summary</div>
          {loading ? (
