      ...
      <div className="bg-white border border-slate-200 rounded-[24px] p-6 mb-6 shadow-sm flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-[15px] text-slate-900">Social Links</h3>
          </div>
          ...
          {hasLinks ? (
            <div className="flex flex-wrap items-center gap-3 mt-4">
             ...
             <p className="text-[13px] text-slate-500">Connect your profiles to build your network</p>
          )}
        </div>
        <button
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-[24px] p-6 mb-6 shadow-sm">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h3 className="font-bold text-[16px] text-slate-900">Social Links</h3>
      </div>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
        <div>
          <label className="block text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">Website URL</label>
          <div className="relative group">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[13px] text-slate-900 w-full focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/50 transition-all placeholder:text-slate-500"
              placeholder="https://yourwebsite.com"
            />
          </div>
        </div>
        <div>
          <label className="block text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">Twitter</label>
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[13px] text-slate-900 w-full focus:outline-none focus:border-[#1DA1F2]/50 focus:ring-1 focus:ring-[#1DA1F2]/50 transition-all placeholder:text-slate-500"
              placeholder="@username"
            />
          </div>
        </div>
        <div>
          <label className="block text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">GitHub</label>
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[13px] text-slate-900 w-full focus:outline-none focus:border-slate-400 focus:ring-1 focus:ring-slate-400 transition-all placeholder:text-slate-500"
              placeholder="https://github.com/..."
            />
          </div>
        </div>
        <div>
          <label className="block text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">LinkedIn</label>
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[13px] text-slate-900 w-full focus:outline-none focus:border-[#0A66C2]/50 focus:ring-1 focus:ring-[#0A66C2]/50 transition-all placeholder:text-slate-500"
