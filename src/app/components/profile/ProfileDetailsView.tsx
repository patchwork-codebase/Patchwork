  ...
  return (
    <>
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center md:justify-start gap-3 sm:gap-4">
                      <h1 className="text-[28px] sm:text-[32px] font-extrabold text-slate-900 font-display tracking-tight leading-tight m-0 text-center md:text-left">
                        {profile.name}
                      </h1>
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                      {/* Role */}
                      <span className="flex items-center justify-center gap-1.5 text-[12px] font-bold text-primary-700 bg-primary-50/50 border border-primary-200/50 px-3 py-1.5 rounded-full capitalize tracking-wide shadow-sm">
                      ...
                      {/* Join Date */}
                      <span className="flex items-center justify-center gap-1.5 text-[12px] font-bold text-slate-600 bg-slate-50/80 border border-slate-200/60 px-3 py-1.5 rounded-full tracking-wide shadow-sm">
                        <Calendar className="w-3.5 h-3.5 text-slate-400" /> Joined {timeAgo(profile.createdAt || '')}
                      </span>
                      
                      {/* Followers (De-emphasized) */}
                      <span className="flex items-center justify-center gap-2 text-[11px] font-medium text-slate-500 tracking-wide px-2">
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-1">
                      {profile.domain_reputation && Object.keys(profile.domain_reputation).length > 0 ? (
                        Object.entries(profile.domain_reputation).map(([domain, score]) => (
                          <div key={domain} className="flex items-center justify-center gap-2 bg-amber-50 border border-amber-200/60 px-4 py-2 rounded-xl shadow-sm">
                        ...
                        <div className="flex items-center justify-center gap-2 bg-amber-50 border border-amber-200/60 px-4 py-2 rounded-xl shadow-sm">
                          <Zap className="w-4 h-4 text-amber-500" />
                          <div className="flex flex-col items-center sm:items-start">
