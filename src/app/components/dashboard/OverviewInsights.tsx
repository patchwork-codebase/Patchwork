...
export function ObserverReactions() {
  ...
  return (
    <div className="bg-[#111111] border border-white/10 rounded-[24px] p-6 sm:p-8 flex flex-col shadow-sm focus-ring w-full">
      ...
      {totalReactions === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center py-8">
          <div className="w-12 h-12 rounded-full bg-[#1a1a1a] border border-white/5 flex items-center justify-center mb-3">
          ...
          <div className="space-y-5 flex-1">
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="font-mono text-[12px] text-slate-400"><span className="text-emerald-500 font-bold">{sharpCount}</span> · {sharpPct}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="font-mono text-[12px] text-slate-400"><span className="text-primary-400 font-bold">{tellMeMoreCount}</span> · {tellMeMorePct}%</span>
              </div>
              <div className="h-1.5 w-full bg-[#1a1a1a] rounded-full overflow-hidden">
...
export function LinkedDocsPanel() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      {/* Card 3: Linked docs */}
      <div className="bg-[#111111] border border-white/10 rounded-[24px] p-6 sm:p-8 flex flex-col shadow-sm focus-ring flex-1">
        <div className="flex flex-col gap-1.5 mb-6">
        ...
        <div className="space-y-3 flex-1 overflow-y-auto max-h-[250px] pr-1">
          {linkedDocs.length === 0 ? (
            ...
            <a href={doc.url} target="_blank" rel="noopener noreferrer" key={i} className="block bg-[#1a1a1a] border border-white/5 rounded-xl p-3.5 hover:bg-white/5 transition-colors cursor-pointer group">
              <div className="flex items-start gap-3 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  <div className="font-semibold text-[13px] text-white mb-1 group-hover:text-primary-500 transition-colors truncate">{doc.title}</div>
        ...
        <button
          ...
          className="w-full mt-4 py-2.5 rounded-xl border border-white/10 text-slate-300 font-semibold text-[13px] hover:bg-white/5 hover:text-white active:scale-95 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div className="bg-[#111111] border border-white/10 rounded-[24px] p-6 sm:p-8 flex flex-col shadow-sm relative overflow-hidden">
        <div className="absolute inset-0 bg-[#111111]/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center text-center">
