            ...
            {myRooms && myRooms.length > 0 ? (
              <>
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-8 h-8 sm:w-auto sm:h-auto sm:px-3 sm:py-1.5 hover:bg-white/10 rounded-full transition-all focus-ring ${showCodeInput ? 'text-primary-400 bg-primary-400/10' : 'text-slate-400 hover:text-white'}`}
                >
