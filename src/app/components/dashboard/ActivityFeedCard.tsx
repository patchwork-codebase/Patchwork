          ...
          >
            <div className="flex items-start justify-between gap-2 sm:gap-3 mb-3">
              ...
              <div className="flex items-start sm:items-center gap-1.5 sm:gap-3 shrink-0 text-right">
                <span className="text-[12px] sm:text-[13px] text-slate-400 max-w-[40px] sm:max-w-none text-right leading-tight mt-0.5 sm:mt-0">{timeAgo(parent.createdAt)}</span>
        ...
        <div className="relative mb-4 sm:mb-6">
          ...
          <div className="ml-4 sm:ml-6 bg-emerald-500/5 border border-emerald-500/20 rounded-[20px] p-4 sm:p-5 hover:shadow-md transition-shadow relative z-10">
            <div className="flex items-start justify-between gap-2 sm:gap-3 mb-3">
              ...
              <div className="flex items-start sm:items-center gap-1.5 sm:gap-3 shrink-0 text-right">
                <span className="text-[12px] sm:text-[13px] text-slate-400 max-w-[40px] sm:max-w-none text-right leading-tight mt-0.5 sm:mt-0">{timeAgo(activity.createdAt)}</span>
                <div className="relative">
                  <button 
