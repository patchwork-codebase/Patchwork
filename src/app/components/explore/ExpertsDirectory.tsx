    ...
    <div className="max-w-[1080px] w-full mx-auto px-4 sm:px-6 py-12 relative overflow-hidden">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white border border-slate-200 rounded-2xl p-5 h-[280px] animate-pulse flex flex-col">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-[32px] px-6 py-16 text-center">
          <p className="text-slate-900 font-bold text-lg">No experts found</p>
