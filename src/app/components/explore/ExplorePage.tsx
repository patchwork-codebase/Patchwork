    ...
    <div className="max-w-[1080px] w-full mx-auto px-4 sm:px-6 py-12 relative overflow-hidden">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-slate-100 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-2xl p-6 h-[200px] animate-pulse">
        ...
        <div className="bg-transparent border border-slate-100 dark:border-slate-800 rounded-[32px] px-6 py-16 text-center backdrop-blur-md">
          <p className="text-slate-900 dark:text-slate-100 font-bold text-lg">No active rooms found</p>
