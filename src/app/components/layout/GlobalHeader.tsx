...
export function GlobalHeader({ unreadCount }: GlobalHeaderProps) {
  return (
    <>
      {/* ── GLOBAL TOP HEADER ─────────────────── */}
      <header className="relative h-[60px] bg-white/40 dark:bg-slate-900/40 backdrop-blur-2xl border-b border-white/40 dark:border-slate-800/50 flex flex-wrap items-center justify-between px-4 sm:px-6 sticky top-0 z-50 shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
