  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-2">Discovery Projects</h1>
          <p className="text-slate-500 text-sm sm:text-base">Validate assumptions and gather signals before you build.</p>
        </div>
        {!isObserver && (
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 border-2 border-dashed border-slate-200 rounded-3xl bg-slate-50">
          ...
          <h2 className="text-xl font-bold text-slate-900 mb-2">No Discovery Projects Yet</h2>
          <p className="text-slate-500 max-w-md mx-auto mb-6">Start a new discovery project to validate your idea with customer interviews, market signals, and clear hypotheses.</p>
        </div>
      ) : (
