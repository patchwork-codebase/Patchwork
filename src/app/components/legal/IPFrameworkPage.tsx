  ...
  return (
    <div className="min-h-screen bg-[#0A0812] text-slate-300 font-sans selection:bg-primary-500/30">
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-24">
        ...
        <button 
          onClick={() => navigate('/')}
          className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-12 text-sm font-bold tracking-wide uppercase"
        >
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-12">
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 text-slate-400 list-disc pl-6">
              <li><strong className="text-white">Public:</strong> Visible to everyone on the internet. Best for marketing and community building.</li>
              <li><strong className="text-white">Unlisted:</strong> Anyone with the link can view, but it's hidden from search and discoverability.</li>
              <li><strong className="text-white">Community Only:</strong> Restricted to logged-in users on the Patchwork platform.</li>
              <li><strong className="text-white">Protected:</strong> Requires an explicit invitation or an approved access request to view.</li>
              <li><strong className="text-white">Stealth (Private):</strong> Visible only to you and designated co-builders.</li>
            </ul>
          </section>
