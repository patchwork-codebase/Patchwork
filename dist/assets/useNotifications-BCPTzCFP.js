import{f as d,r as c,s as i}from"./index-BaPb8-fP.js";import{u as h}from"./useQuery-BDzgDV8V.js";import{u as m}from"./useMutation-rj3j1IXZ.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
