import{e as d,r as c,s as i}from"./index-Cjmk3Htb.js";import{u as h}from"./useQuery-Byagv3h6.js";import{u as m}from"./useMutation-C_8UhN6y.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
