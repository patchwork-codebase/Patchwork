import{e as d,r as c,s as i}from"./index-BXB0ulJl.js";import{u as h}from"./useQuery-8TfsLz6X.js";import{u as m}from"./useMutation-idFLDkvf.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
