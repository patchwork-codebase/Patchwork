import{f as d,r as c,s as i}from"./index-oubWjTv5.js";import{u as h}from"./useQuery-DKx2MssQ.js";import{u as m}from"./useMutation-YWLkB51E.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
