import{f as d,r as c,s as i}from"./index-DoCIXI0v.js";import{u as h}from"./useQuery-N86HvxdB.js";import{u as m}from"./useMutation-D58G6fGK.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
