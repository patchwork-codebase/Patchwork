import{e as d,r as c,s as i}from"./index-CmWusqyW.js";import{u as h}from"./useQuery-C6SgF7Tv.js";import{u as m}from"./useMutation-Dt6y5D4I.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
