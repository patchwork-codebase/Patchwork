import{e as d,r as c,s as i}from"./index-dHsvE6he.js";import{u as h}from"./useQuery-C0URn5ro.js";import{u as m}from"./useMutation-CSyjXciv.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
