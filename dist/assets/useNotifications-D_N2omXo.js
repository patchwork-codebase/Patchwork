import{e as d,r as c,s as i}from"./index-CpVvzA-l.js";import{u as h}from"./useQuery-HDtY5FOA.js";import{u as m}from"./useMutation-CBIaIrRv.js";function w(t){var s;const o=d(),r=h({queryKey:["notifications",t],queryFn:async()=>{if(!t)return[];const{data:e,error:n}=await i.from("notifications").select(`
          *,
