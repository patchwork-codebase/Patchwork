...
export function AiBuildDigestCard({ room, isBuilder, onPostAsUpdate }: AiBuildDigestCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-white via-primary-50/30 to-white dark:from-slate-900 dark:via-primary-950 dark:to-slate-900 border border-primary-500/20 rounded-[24px] p-6 text-slate-900 dark:text-white shadow-xl relative overflow-hidden mb-6">
        ...
        {!digest ? (
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-3 py-1.5 bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 text-slate-900 dark:text-white text-xs font-bold rounded-lg transition-all flex items-center gap-1.5 border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none"
            >
            ...
            <button
              onClick={generateDigest}
              className="p-1.5 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-white/10 rounded-lg transition-colors"
              title="Regenerate"
            >
      ...
      {digest && (
        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/10 relative z-10">
          <div className="bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-white/10 rounded-xl p-4 text-xs leading-relaxed text-slate-700 dark:text-slate-300 font-mono whitespace-pre-line">
            {digest}
          </div>
