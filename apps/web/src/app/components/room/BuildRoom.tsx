    ...
    <>
      ...
      <div className="max-w-[1000px] w-full mx-auto px-4 sm:px-6 py-6 md:py-10 relative">
        ...
        <div className="relative mb-8 w-full group/tabs">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-white dark:from-[#0a0a0a] to-transparent z-10 pointer-events-none opacity-100 transition-opacity rounded-l-2xl" />
          <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-white dark:from-[#0a0a0a] to-transparent z-10 pointer-events-none opacity-100 transition-opacity rounded-r-2xl" />
