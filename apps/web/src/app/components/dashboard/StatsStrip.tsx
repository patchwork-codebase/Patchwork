          ...
          {s.loading ? (
            ...
            <div className="flex flex-col h-full relative z-10">
              <div className="flex justify-between items-start w-full mb-3">
                ...
                {s.icon && (
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 shrink-0 rounded-full flex items-center justify-center ${s.iconBg} ${s.iconColor} ring-1 ring-inset ${s.deltaBorder} group-hover:scale-110 transition-transform duration-300`}>
                    <s.icon strokeWidth={2.5} className="w-4 h-4 sm:w-[18px] sm:h-[18px]" />
                  </div>
                )}
              </div>
