  ...
  return (
    <div className="bg-[#1A1825] border border-white/[0.08] rounded-[24px] p-6 shadow-xl relative overflow-hidden">
      <div className="flex items-center gap-3 mb-6 pb-6 border-b border-white/[0.08]">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Expert Review Template</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">Structured feedback yields the highest quality guidance.</p>
        </div>
      </div>
      ...
      <form id="expert-review-form" onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Reflect back what you understand about their build and challenge.</p>
          <textarea
            ...
            className="w-full px-5 py-4 bg-ink/50 border border-white/[0.08] rounded-xl text-[14px] text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500/50 resize-none"
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Identify the strengths of their current approach.</p>
          <textarea
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Highlight potential pitfalls or edge cases they might have missed.</p>
          <textarea
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">What are other ways to solve this challenge?</p>
          <textarea
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Your final, actionable recommendation.</p>
          <textarea
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Questions you have for the builder.</p>
          <textarea
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-white/[0.08]">
          <div className="space-y-3">
            <label className="text-sm font-bold text-slate-900 dark:text-white flex justify-between">
              Confidence Level 
        ...
        <div className="flex justify-end gap-4 pt-6">
          <button type="button" onClick={onClose} className="px-6 py-3 rounded-xl font-bold text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white transition-colors">
            Cancel
          </button>
